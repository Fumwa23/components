...
const Item = ({ feature, isOpen, setFeatureSelected }) => {
  ...
  return (
    <li>
      <button
        className="relative flex gap-2 items-center w-full py-5 text-base font-medium text-left md:text-lg duration-300 hover:scale-105"
        onMouseEnter={(e) => {
          e.preventDefault();
          setFeatureSelected();
        }}
...
const FeaturesAccordionStatic = (props) => {
...
export default FeaturesAccordionStatic;