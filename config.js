const config = {
  ...
  domainName: process.env.NODE_ENV === "development" ? "http://localhost:3000" : "dealflow-ai.vercel.app",
  crisp: {
  ...
  mailgun: {
    ...
    fromNoReply: `VideoFunnels <noreply@mg.VideoFunnels.com>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `Founders at ShipFast <founders@mg.VideoFunnels.com>`,
    // Email shown to customer if need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "founders@mg.VideoFunnels.com",
